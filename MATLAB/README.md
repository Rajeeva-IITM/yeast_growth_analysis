...
The files below will be available on [Zenodo](https://zenodo.org/). Download and extract the data archive into this directory.
...
| `models/strain_models_gimme/*.mat` | ~267 MB total | Generated by running Step 2 with 'GIMME' algorithm |
