...
### Not included (available on Zenodo)

<!-- TODO: Add Zenodo DOI link once published -->
The files below will be available on [Zenodo](https://zenodo.org/) in the exact directory structure expected by this sub-repo. Download and extract the data archive into this directory.

| File | Size | How to obtain |
|------|------|---------------|
| `models/yeast8_ynb_final.mat` | ~537 KB | Generated by running Step 1 (`make_ynb.m`). |
| `data/expressionValues_imputed_median_antilog.csv` | ~69 MB | Gene expression matrix from [Albert et al. 2018](https://elifesciences.org/articles/35471). |
| `models/strain_models_gimme/*.mat` | ~267 MB total | Generated by running Step 2. |
| `models/strain_models_sprint/*.mat` | ~176 MB total | Generated by Sprint gap-filling. |
